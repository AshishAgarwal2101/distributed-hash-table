...
4. Hit the below endpoint: <br />
    "http://localhost:3000/4001" which is of the format "http://localhost:3000/\<any-node with known port>" <br />
    This endpoint would return the finger entries for all the three nodes: <br /> <br />
